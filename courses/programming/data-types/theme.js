const mode = () => {
    ...
    container.addEventListener('click', () => {
        ...
        if(i%2 === 1)
        {
            ...
            {
                table[j].style.border = "1px solid #000000";
            }
            for(j = 0; j < th.length; j++)
            {
                th[j].style.border = "1px solid #000000";
            }
            for(j = 0; j < td.length; j++)
            {
                td[j].style.border = "1px solid #000000";
            }
        ...
        else if(i%2 === 0)
        {
            ...
            for(j = 0; j < table.length; j++)
            {
                table[j].style.border = "1px solid #e1e2d2";
            }
            for(j = 0; j < th.length; j++)
            {
                th[j].style.border = "1px solid #e1e2d2";
            }
            for(j = 0; j < td.length; j++)
            {
                td[j].style.border = "1px solid #e1e2d2";
            }
            document.getElementById('pagenum-2').style.color = "#1ba098";
            document.getElementById('pagenum-3').style.color = "#1ba098";
        }
    })
}
