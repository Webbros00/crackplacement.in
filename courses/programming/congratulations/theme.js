const mode = () => {
    ...
    var topics = document.querySelectorAll('.page .proglist ul li a');
    var j;
    ...
    container.addEventListener('click', () => {
        ...
        if(i%2 === 1)
        {
            ...
            document.getElementById('pageh2').style.color = "#000000";
        ...
        else if(i%2 === 0)
        {
            ...
            document.getElementById('pageh2').style.color = "#e1e2d2";
            document.getElementById('pageh1').style.color = "#1ba098";
            for(j = 0; j < topics.length; j++)
            {
                topics[j].style.color = "#e1e2d2";
            }
        }
    })
}
